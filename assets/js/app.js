...
function xScale(health, chosenXAxis) {
  ...
  var xLinearScale = d3.scaleLinear()
    .domain([d3.min(health, d => d[chosenXAxis]) * 0.8,
      d3.max(health, d => d[chosenXAxis]) * 1.2
    ])
    .range([0, width]);
...
d3.csv("data.csv").then(function(health) {
    console.log("before error check, health", health);
  ...
  console.log("after csv file loaded")
  ...
  var yLinearScale = d3.scaleLinear()
    .domain([6, d3.max(health, d => d.smokes)+2])
    .range([height, 0]);
